...
if(!isset($_SESSION['pseudo'])){
	header('Location: tchat_visiteur.php');
}
?>
...
while($donnees = $data1->fetch(PDO::FETCH_BOTH)){
	...
	echo ' <a href="editchat.php?id='.$donnees['id'].'">Editer</a>';
	?>

	<a href="delchat.php?id=<?php echo $donnees['id']; ?>"><br><br>Supprimer</a>
	<?php
echo '<br><hr>';
	}
}
...
if(isset($_POST['valider'])){
	...
	$db->query("INSERT INTO tchat(id, auteur, contenu, date, temps) VALUES (NULL, '".$auteurS."', '".$contenuS."', NOW(), NOW())");
...
<form action="" method="post">
	Votre message:<br><textarea name="contenu"></textarea><br>
...
while($donnees = $data1->fetch(PDO::FETCH_BOTH)){
	...
	echo ' <a href="editchat.php?id='.$donnees['id'].'">Editer</a><br><br>';
	echo ' <a href="delchat.php?id='.$donnees['id'].'">Supprimer</a><br><br>';
}
